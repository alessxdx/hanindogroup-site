...
(function () {
  var DICT = {
    ...
    "Beyond supplying equipment, we support the full lifecycle of every solution — from specification and installation to commissioning, operator training, spare parts and after-sales service. As the sole distributor in Indonesia for Airtec, HPA-Faip and RAASM, alongside our own brands WELDANN, ATOM and HAKIRO, we equip workshops and industrial facilities with reliable solutions from a single partner.": "Lebih dari sekadar memasok peralatan, kami mendukung seluruh proses mulai dari penentuan spesifikasi dan pemasangan hingga commissioning, pelatihan operator, suku cadang, dan layanan purnajual. Sebagai distributor tunggal di Indonesia untuk Airtec, HPA-Faip, dan RAASM, bersama merek kami sendiri WELDANN, ATOM, dan HAKIRO, kami melengkapi bengkel dan fasilitas industri dengan solusi andal dari satu mitra.",
    ...
    "Professional workshop equipment for demanding service environments, covering tyre service, lifts, fluid exchange, brake and diagnostic solutions. Supported by warranty, training and after-sales service across Indonesia.": "Peralatan bengkel profesional untuk lingkungan kerja berat, mencakup layanan ban, lift, penggantian fluida, serta solusi rem dan diagnostik. Didukung garansi, pelatihan, dan layanan purnajual di seluruh Indonesia.",
