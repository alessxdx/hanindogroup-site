...
(function () {
  var DICT = {
    ...
    "Authorised dealers": "Bengkel Resmi",
    ...
    "The Line for Workshop": "Lini untuk peralatan bengkel",
    "and Industrial Equipment": "dan industri",
    "Singapore": "Singapura",
    "Italy": "Italia",
    ...
    "WELDANN, ATOM and HAKIRO.": "WELDANN, ATOM, dan HAKIRO.",
    "Alongside the international manufacturers we represent, PT. Hanindo Automotive develops and supplies equipment under our own brands — WELDANN, ATOM and HAKIRO. We manage the specifications, spare parts, warranty and after-sales support to ensure reliable long-term performance.": "Selain merek internasional yang kami wakilkan, PT. Hanindo Automotive mengembangkan dan memasok peralatan di bawah merek kami sendiri — WELDANN, ATOM, dan HAKIRO. Kami mengelola spesifikasi, suku cadang, garansi, dan dukungan setelah pembelian untuk memastikan kinerja yang andal dalam jangka panjang.",
    "Professional workshop equipment for demanding service environments, covering tyre service, lifts, fluid exchange, brake and diagnostic solutions. Supported by warranty, training and after-sales service across Indonesia.": "Peralatan bengkel profesional untuk lingkungan kerja berat, mencakup layanan ban, lift, penggantian fluida, serta solusi rem dan diagnostik. Didukung garansi, pelatihan, dan layanan setelah pembelian di seluruh Indonesia.",
    "A semi-automatic swing-arm tyre changer designed for tyre shops and workshops, offering a practical and reliable solution for everyday tyre servicing.": "Tyre changer semi-otomatis lengan ayun yang dirancang untuk bengkel ban dan bengkel umum, menghadirkan solusi praktis dan andal untuk servis ban sehari-hari.",
    "Vehicle lifts including mid-rise, in-ground, on-ground scissor and two-post lifts from 3.5 to 4 tonnes. Built with quality components and safety features for reliable workshop operations.": "Lift kendaraan meliputi scissor lift mid-rise, tanam, dan permukaan, serta lift dua tiang dari 3,5 hingga 4 ton. Dibuat dengan komponen berkualitas dan fitur keselamatan untuk operasional bengkel yang andal.",
    ...
    "Provide complete support from equipment selection and installation to training, spare parts and after-sales service.": "Memberikan dukungan menyeluruh mulai dari pemilihan dan pemasangan peralatan hingga pelatihan, suku cadang, dan layanan setelah pembelian.",
    ...
    "From equipment selection and installation to operator training, spare parts and after-sales service — supported by our own team.": "Dari pemilihan dan pemasangan peralatan hingga pelatihan operator, suku cadang, dan layanan setelah pembelian — didukung oleh tim kami sendiri.",
    ...
    "Service visits and genuine spare parts, backed by after-sales support from the team that installed the machine.": "Kunjungan servis dan suku cadang asli, didukung layanan setelah pembelian dari tim yang memasang mesin tersebut.",
    ...
    "Five models — two semi-automatic swing-arm, three automatic tilting-post, 20\" through 24\".": "Lima model — dua semi-otomatis lengan ayun, tiga otomatis tilting-post, 20″ hingga 24″.",
    ...
    /* The M31 and M20 notes both end "Optional <b>MODEL</b> helper arm.",
       and an inline <b> splits the sentence into three text nodes. The
       trailing fragment is shared by both cards, so one entry covers them. */
    "helper arm.": "lengan bantu.",
    "The smaller of the two swing-arm machines: the arm swings aside by hand rather than tilting back, so it stands against a wall, and it clamps to 20″ where the M31 reaches 21″. Two-speed motor on a pedal control. Optional": "Mesin lengan ayun yang lebih kecil dari keduanya: lengannya diayun ke samping dengan tangan alih-alih dimiringkan ke belakang, sehingga dapat ditempatkan menempel dinding, dan mencengkeram hingga 20″ sementara M31 mencapai 21″. Motor dua kecepatan dengan kendali pedal. Opsional",
