...
(function () {
  var DICT = {
    ...
    "Beyond supplying equipment, we support the full lifecycle of every solution — from specification and installation to commissioning, operator training, spare parts and after-sales service. As the sole distributor in Indonesia for Airtec, HPA-Faip and RAASM, alongside our own brands WELDANN, ATOM and HAKIRO, we equip workshops and industrial facilities with reliable solutions from a single partner.": "Lebih dari sekadar memasok peralatan, kami mendukung seluruh proses mulai dari penentuan spesifikasi dan pemasangan hingga komisioning, pelatihan operator, suku cadang, dan layanan purnajual. Sebagai distributor tunggal di Indonesia untuk Airtec, HPA-Faip, dan RAASM, bersama merek kami sendiri WELDANN, ATOM, dan HAKIRO, kami melengkapi bengkel dan fasilitas industri dengan solusi andal dari satu mitra.",
