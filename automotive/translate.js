...
(function () {
  var DICT = {
    ...
    "Professional workshop equipment designed for demanding service environments, covering tyre service, lifts, fluid exchange, brake and diagnostic solutions. Supported by warranty, training and after-sales service across Indonesia.": "Peralatan bengkel profesional yang dirancang untuk lingkungan kerja berat, mencakup layanan ban, lift, penggantian fluida, serta solusi rem dan diagnostik. Didukung garansi, pelatihan, dan layanan purnajual di seluruh Indonesia.",
    "A semi-automatic swing-arm tyre changer — the starting point for tyre shops just setting up.": "Tyre changer semi-otomatis, solusi untuk bengkel ban yang baru memulai usahanya.",
