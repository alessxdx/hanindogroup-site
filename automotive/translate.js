...
(function () {
  var DICT = {
    ...
    "Hanindo Automotive fits out the service bay and keeps it running — tyre changers, wheel balancers and 3D wheel alignment, vehicle lifts, fluid exchange and diagnostics, lubrication systems and welding plant, specified from one supplier and backed by one team.": "Hanindo Automotive melengkapi service bay dan menjaganya tetap berjalan — tyre changer, wheel balancer dan spooring 3D, lift kendaraan, penggantian fluida dan alat diagnostik, sistem pelumasan, serta mesin las, ditentukan dari satu pemasok dan didukung satu tim.",
    ...
    "Two brands of our own, WELDANN and ATOM — our specification, our spare parts, our warranty": "Dua merek milik kami sendiri, WELDANN dan ATOM — spesifikasi kami, suku cadang kami, garansi kami",
    "Installed and commissioned by our own technicians, with operator training and after-sales service behind it": "Dipasang dan dikomisioning oleh teknisi kami sendiri, dengan pelatihan operator dan layanan purnajual di belakangnya",
    "Fluid handling beyond the workshop — RAASM reels, pumps and dispensing systems supplied to lubricant distributors, plants and mine sites": "Penanganan fluida di luar bengkel — reel, pompa, dan sistem dispensing RAASM dipasok ke distributor pelumas, pabrik, dan lokasi tambang",
    ...
    "Sole distributor,": "Distributor tunggal,",
    "and maker in our own right": "sekaligus produsen kami sendiri",
    ...
    "Two things sit behind the catalogue. The company is sole distributor in Indonesia for three international principals — Airtec digital tyre inflation, HPA-Faip aligners, balancers and tyre changers, and RAASM fluid handling — and it builds two brands of its own, WELDANN and ATOM. Between them they equip a workshop from the bay floor up.": "Ada dua hal di balik katalog ini. Perusahaan adalah distributor tunggal di Indonesia untuk tiga prinsipal internasional — Airtec untuk pengisian angin ban digital, HPA-Faip untuk alat spooring, balancing, dan tyre changer, serta RAASM untuk penanganan fluida — dan membangun dua merek miliknya sendiri, WELDANN dan ATOM. Keduanya bersama-sama melengkapi bengkel dari lantai bay ke atas.",
    ...
    "Airtec, HPA-Faip and RAASM each appoint one distributor for Indonesia, and each of them appointed us. That is a working arrangement rather than a badge on a logo: we carry the stock, commission the machines, hold the spare parts and train the technicians — so equipment bought here is supported here, not from a factory on the other side of the world.": "Airtec, HPA-Faip, dan RAASM masing-masing menunjuk satu distributor untuk Indonesia, dan ketiganya menunjuk kami. Itu adalah kerja sama yang nyata, bukan sekadar lencana pada logo: kami menyediakan stok, mengomisioning mesin, menyimpan suku cadang, dan melatih teknisi — sehingga peralatan yang dibeli di sini juga didukung di sini, bukan dari pabrik di belahan dunia lain.",
    "The three principals we are sole distributor for in Indonesia:": "Tiga prinsipal yang kami pegang sebagai distributor tunggal di Indonesia:",
