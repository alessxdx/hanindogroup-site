...
(function () {
  var DICT = {
    ...
    "Airtec Corporation builds digital tyre inflation equipment in Singapore, to ISO 9001:2015 certified by SGS. An automatic inflator takes a target pressure and holds a tyre to it — no gauge, no operator standing over it — and Hanindo Automotive is its sole distributor in Indonesia.": "Airtec Corporation membuat peralatan pengisian angin ban digital di Singapura, dengan sertifikasi ISO 9001:2015 dari SGS. Pengisi angin otomatis menerima tekanan target dan menjaga ban tetap pada tekanan itu — tanpa alat ukur, tanpa operator yang harus menunggui — dan Hanindo Automotive adalah distributor tunggalnya di Indonesia.",
    ...
    "RAASM builds fluid handling equipment in Vicenza — hose reels, pumps, oil and grease dispensing, waste oil handling and centralised lubrication. Hanindo Automotive is its sole distributor in Indonesia, for the industrial range as much as the workshop one.": "RAASM membuat peralatan penanganan fluida di Vicenza — reel selang, pompa, dispensing oli dan gemuk, penanganan oli bekas, dan pelumasan terpusat. Hanindo Automotive adalah distributor tunggalnya di Indonesia, untuk rangkaian industri sama halnya dengan rangkaian bengkel.",
