...
(function () {
  var DICT = {
    ...
    /* The lead under "Everything fuel moves through" is three entries, not
       ...
       phone can break the sentences apart; the match is on a whole trimmed
       text node, so the joined version stopped matching the moment it was
       split and the lead silently reverted to English on every switch.
       The Indonesian is the wording that was already here, cut at the same
       three sentence boundaries — not a retranslation.
       If those sentences are ever rejoined or re-split, re-key them here. */
    "PT. Hanindo Citra supplies, installs and services the equipment used to dispense, measure and monitor fuel — including dispensers, submersible turbine pumps, automatic tank gauging systems, flow meters, forecourt controllers and fuel management systems.": "PT. Hanindo Citra memasok, memasang, dan merawat peralatan yang digunakan untuk menyalurkan, mengukur, dan memantau bahan bakar — termasuk dispenser, pompa turbin submersible, sistem automatic tank gauging, flow meter, forecourt controller, dan sistem manajemen bahan bakar.",
    "These systems support retail forecourts, fuel depots, marine terminals, aviation fuelling and industrial sites.": "Sistem ini mendukung forecourt ritel, depot bahan bakar, terminal laut, pengisian bahan bakar penerbangan, dan lokasi industri.",
    ...
    "Built for truck stops and commercial lanes, where pumping time is the constraint rather than forecourt space. Ultra-high-flow masters and satellites roughly halve the time it takes to fill and pay, reaching a combined flow rate of up to 63 gpm when a master and satellite are used together. More fuel moves during the busy hours and drivers get back on the road faster.": "Dibuat untuk truck stop dan jalur komersial, di mana kendalanya adalah waktu pengisian, bukan luas forecourt. Master dan satelit berdebit sangat tinggi memangkas waktu mengisi dan membayar hingga sekitar setengahnya, mencapai laju aliran gabungan hingga 63 gpm bila master dan satelit dipakai bersama. Lebih banyak bahan bakar tersalurkan pada jam sibuk dan pengemudi lebih cepat kembali ke jalan.",
    ...
    "The controller does not wire to the pumps directly. Distribution modules sit between them, and the module is what determines which protocol a channel speaks. A site with mixed dispenser brands is handled by ordering different modules, not different controllers.": "Controller tidak dikabelkan langsung ke pompa. Modul distribusi berada di antaranya, dan modul itulah yang menentukan protokol yang dipakai sebuah kanal. Lokasi dengan merek dispenser campuran ditangani dengan memesan modul yang berbeda, bukan controller yang berbeda.",
    "Distribution Modules": "Modul Distribusi",
