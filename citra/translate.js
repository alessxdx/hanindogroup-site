...
(function () {
  var DICT = {
    ...
    "The same systems run retail forecourts, fuel depots, marine terminals, aviation fuelling and industrial sites.": "Sistem yang sama menjalankan forecourt ritel, depot bahan bakar, terminal laut, pengisian bahan bakar penerbangan, dan lokasi industri.",
    "The company also builds fuel stations from consultation and design through construction to the day the site opens.": "Perusahaan ini juga membangun SPBU, dari konsultasi dan perancangan hingga pembangunan, sampai hari lokasi mulai beroperasi.",
