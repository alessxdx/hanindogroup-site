...
(function () {
  var DICT = {
    ...
    "To lead the petroleum equipment and automotive equipment business in Indonesia — from one division of PT. Sugiron Citra to the six companies of the group today.": "Menjadi yang terdepan dalam bisnis peralatan perminyakan dan peralatan otomotif di Indonesia — dari satu divisi PT. Sugiron Citra hingga menjadi enam perusahaan dalam grup ini hari ini.",
    "Where it began": "Awal mula",
    "Petroleum equipment at PT. Sugiron Citra.": "Peralatan perminyakan di PT. Sugiron Citra.",
    "Hanindo Citra": "Hanindo Citra",
    "The division becomes its own company.": "Divisi tersebut menjadi perusahaan tersendiri.",
    "Hanindo Automotive": "Hanindo Automotive",
    "Workshop equipment joins the group.": "Peralatan bengkel bergabung dengan grup.",
    "Flowtech Engineering": "Flowtech Engineering",
    "Station construction brought in-house.": "Konstruksi SPBU dikerjakan sendiri.",
    "Custom partnership": "Kemitraan Custom",
    "Printer integration for Indonesia.": "Integrasi printer untuk Indonesia.",
    "Into China": "Masuk ke Tiongkok",
    "Shanghai opens, Shenzhen follows in 2010.": "Shanghai dibuka, Shenzhen menyusul pada 2010.",
    "Automation Solutions": "Automation Solutions",
    "Printing and POS company in Jakarta.": "Perusahaan pencetakan dan POS di Jakarta.",
    "Gralessando": "Gralessando",
    "Singapore company covers South East Asia.": "Perusahaan Singapura yang mencakup Asia Tenggara.",
    "Vietnam, then Thailand": "Vietnam, lalu Thailand",
    "Regional partnerships, Thailand in 2019.": "Kemitraan regional, Thailand pada 2019.",
    "Manila office": "Kantor Manila",
    "New office in the Philippines.": "Kantor baru di Filipina.",
