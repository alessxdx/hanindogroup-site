...
(function () {
  var DICT = {
    ...
    /* The first paragraph carries an inline link, so it reaches the walker
       as two text nodes either side of the anchor and needs an entry per
       side. The link text is not translated: "CUSTOM China" is a company
       name. */
    ...
    "Today, PT. Hanindo Automation Solutions focuses on CUSTOM printing, scanning and point-of-sale solutions, supported by local system integration and technical expertise.": "Saat ini, PT. Hanindo Automation Solutions berfokus pada solusi pencetakan, scanning, dan point-of-sale CUSTOM, didukung integrasi sistem dan keahlian teknis lokal.",
