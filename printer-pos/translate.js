...
(function () {
  var DICT = {
    ...
    "Gralessando Pte Ltd is incorporated in Singapore and is represented as Custom (S.E.A). It covers South East Asia — Singapore, Malaysia, Vietnam, Thailand and the Philippines. The Indonesian market is served by PT. Hanindo Automation Solutions, the group's Jakarta company.": "Gralessando Pte Ltd berbadan hukum di Singapura dan diwakili sebagai Custom (S.E.A). Perusahaan ini mencakup Asia Tenggara — Singapura, Malaysia, Vietnam, Thailand, dan Filipina. Pasar Indonesia dilayani oleh PT. Hanindo Automation Solutions, perusahaan grup yang berbasis di Jakarta.",
