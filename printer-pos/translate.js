...
(function () {
  var DICT = {
    ...
    /* ---- home ---- */
    "Gralessando (S) Pte. Ltd. supplies the printing, scanning and point-of-sale hardware and software behind retail and hospitality automation.": "Gralessando (S) Pte. Ltd. memasok perangkat keras dan perangkat lunak pencetakan, scanning, dan point-of-sale yang mendukung otomasi ritel dan perhotelan.",
    ...
    "Gralessando (S) Pte. Ltd. is incorporated in Singapore and is represented as CUSTOM (S.E.A) Hanindo. The Indonesian market is served by PT. Hanindo Automation Solutions, while the China market is served by Hanindo (Shanghai) International Co., Ltd.": "Gralessando (S) Pte. Ltd. berbadan hukum di Singapura dan diwakili sebagai CUSTOM (S.E.A) Hanindo. Pasar Indonesia dilayani oleh PT. Hanindo Automation Solutions, sedangkan pasar China dilayani oleh Hanindo (Shanghai) International Co., Ltd.",
    ...
    "Installation, technical assistance and after-sales service from our Singapore office and appointed partners.": "Pemasangan, bantuan teknis, dan layanan setelah pembelian dari kantor Singapura dan mitra yang kami tunjuk.",
